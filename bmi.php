...
body {
  ...
  background-image:linear-gradient(rgb(0 0 0 / 0%),rgb(0 0 0 / 0%)),url('assets/images/pexels-peter-fazekas-1089455.jpg');
...
.form {
  ...
  box-shadow: 0 0 40px 0 #cbe7fd91;
}
...
.checkmark {
  ...
  height: 25px;
  width: 25px;
  background-color: #dbeffe59;
  border-radius: 50%;
}

.container:hover input ~ .checkmark {
  background-color: #19ff0978;
}
.container input:checked ~ .checkmark {
    background-color: rgb(33 230 20 / 55%);
}
